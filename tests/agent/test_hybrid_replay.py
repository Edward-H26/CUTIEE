...
async def test_runner_executes_prematched_nodes_at_tier_zero() -> None:
    ...
    prematched = [
        ActionNode(
            action_type="navigate", target="https://docs.google.com", description="open sheet"
        ),
        ActionNode(action_type="click_at", coord_x=100, coord_y=200, description="locate column C"),
    ]
